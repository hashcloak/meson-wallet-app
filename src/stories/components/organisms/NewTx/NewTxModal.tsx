    ...
    <div className='flex flex-col text-textWhite'>
      <div className='py-4 px-8 rounded-2xl bg-bgDarkLight'>
        ...
        <div className='flex flex-row justify-around'>
          <Button btnVariant={'primary'} btnSize={'lg'} btnType={'button'}>
...
const NewTxModal: React.FC<Props> = ({ isOpen, onClose }) => {
  return (
    <>
      <Dialog
        open={isOpen}
      ...
      >
        <div className='flex items-center justify-center min-h-screen'>
          ...
          <Dialog.Panel className='relative bg-bgDarkMid rounded-2xl py-6 px-8'>
            <span className='text-textWhite text-2xl font-bold'>Header</span>
