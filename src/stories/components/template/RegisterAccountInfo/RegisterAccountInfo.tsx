        ...
        <StepWrapper>
          ...
          <StepContentLayout>
            <div className='flex flex-col text-textWhite text-base max-w-[35rem]'>
              ...
              <span>
                ...
                out the first owner with your connected wallet details, but you
                can also assign a different owner.
              </span>
            </div>
          ...
          <StepContentLayout>
            <div className='flex flex-col text-textWhite text-base max-w-[35rem]'>
              ...
              <Spacer size={8} axis={'vertical'} />
              <span>
                Specifying how many of them need to confirm a transaction before
                it gets executed. <br />
                Basically, the more confirmations required, the more secure your
                Meson Wallet is.
              </span>
            </div>
