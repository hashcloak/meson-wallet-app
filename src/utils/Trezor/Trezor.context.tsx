...
export interface ITrezorContext {
  ...
  getSignedRawTransferTx: (params: ITransferSlpRequest) => Promise<{ signedRawTx: string }>
...
export const TrezorContext = createContext<ITrezorContext | any>({} as ITrezorContext)
