...
const LoaderSuccess: React.FC<Props> = ({ isLoading }) => {
  return (
    <>
      <Dialog open={isLoading} onClose={() => false} className='fixed z-10 inset-0 overflow-y-auto'>
            ...
            <Dialog.Description>
              <div className='rounded-2xl p-4 flex flex-col items-center'>
                ...
                <div className='flex flex-col items-center'>
                  <span className='text-2xl	text-textWhite font-bold'>Successfully created!</span>
                  <Spacer size={8} axis={'vertical'} />
                  <span className='text-base text-textWhite'>Redirect to dashboard</span>
                </div>
              </div>
            </Dialog.Description>
          </Dialog.Panel>
