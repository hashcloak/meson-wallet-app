...
const TableRowLong: React.FC<Props> = ({ tx }) => {
  ...
  return (
    <>
      <div
        className='flex items-center justify-between rounded-2xl px-4 h-16 bg-bgGrayLight  dark:bg-bgDarkLight hover:bg-dark whitespace-nowrap mb-2 w-full min-w-[86.5rem]'
