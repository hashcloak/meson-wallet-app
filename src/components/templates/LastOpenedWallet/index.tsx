...
const LastOpenedWallet: React.FC<Props> = ({ wallets }) => {
  ...
  return (
    <div className='w-[51rem] max-h-[27rem] min-h-[6.5ren] bg-bgDarkMid py-4 px-8 rounded-2xl box-border '>
      <span className='text-textWhite text-xl font-bold'>Last Opened Wallets</span>
      ...
      {wallets && wallets ? (
        ...
        <div className='flex items-center justify-center w-full mb-4'>
          <span className='text-textGrayLight text-base text-center'>No wallet recently used</span>
        </div>
      )}
    </div>
  )
